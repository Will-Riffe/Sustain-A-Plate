  ...
  return (
    <div className="home-container">
      ...
      <section className="card-section">
        ...
        <p>
          We are committed to making zero food waste a reality. Our focus is on
          making sustainable eating the most convenient way to eat, benefiting
      ...
      <section className="card-section">
        ...
        <p>
          We connect businesses that have surplus food with charities and
          community groups to ensure no food goes to waste, benefiting those who
          need it most.
        </p>
      </section>
      </div>
